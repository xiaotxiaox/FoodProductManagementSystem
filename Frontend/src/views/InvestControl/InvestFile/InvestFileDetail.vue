    ...
    methods: {
      ...
      handleChange (info) {
        if (info.file.status === 'done') {
          ...
          api. createInvestFileItemFile(this.id, this.file)
            .then(data => {
      ...
      handleDelete (record) {
        api.deleteInvestFileItemFile(record.id)
          .then(data => {
