        ...
        <a-date-picker
          ...
          v-decorator="[
                ...
                {rules: [{ type: 'object', required: true, message: '请输入订货日期' }],
                 initialValue: isEdit ? record.orderDate : null}
              ]">
        </a-date-picker>
      </a-form-item>
      <a-form-item
            ...
            getData() {
                ...
                if (this.isEdit) {
                    if (this.record.orderDate !== null) {
                        this.record.orderDate = new moment(this.record.orderDate)
                    }
                    if (this.record.pickDate !== null) {
                        this.record.pickDate = new moment(this.record.pickDate)
                    }
                }
            },
            handleOk() {
                this.form.validateFields((error, data) => {
                    if (!error) {
                        ...
                        if (data.pickDate)
                            data.pickDate = data.pickDate.format('YYYY-MM-DD')
                        if (this.isEdit) {
