  ...
  export default {
    ...
    methods: {
      getData () {
        ...
        api. getInvestChangeFile2(this.id)
          .then(data => {
            this.name=data.name
      ...
      handleChange (info) {
        if (info.file.status === 'done') {
          ...
          api. createInvestChangeFile2(this.id, this.file)
            .then(data => {
      ...
      handleDelete (record) {
        api.deleteInvestChangeFile2(record.id)
          .then(data => {
