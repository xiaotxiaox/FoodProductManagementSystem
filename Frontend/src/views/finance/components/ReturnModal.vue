      ...
      <a-form-item
        ...
        <a-input
          ...
          v-decorator="[
            ...
            {
              rules: [
             {required: true, message: '请输入退款金额/补交金额'}
              ],
              validateTrigger: 'blur',
              initialValue: record ? record.backMoney : null
            }
          ]">
        </a-input>
      </a-form-item>
        ...
        <a-date-picker
          ...
          v-decorator="[
                ...
                {rules: [{ type: 'object', required: true, message: '请输入退货同意日期' }],
                 initialValue: isEdit ? record.backDate : null}
              ]">
        </a-date-picker>
      </a-form-item>
      <a-form-item
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                if (this.isEdit) {
                    if (this.record.backDate !== null) {
                        this.record.backDate = new moment(this.record.backDate)
                    }
                }
            },
            handleOk() {
                this.form.validateFields((error, data) => {
                    if (!error) {
                        if (data.backDate)
                            data.backDate = data.backDate.format('YYYY-MM-DD')
                        if (this.isEdit) {
