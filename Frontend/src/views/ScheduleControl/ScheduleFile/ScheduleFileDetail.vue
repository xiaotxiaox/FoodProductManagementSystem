    ...
    methods: {
      ...
      handleChange (info) {
        if (info.file.status === 'done') {
          ...
          api.createScheduleFileItemFile(this.id, this.file)
            .then(data => {
      ...
      handleDelete (record) {
        api.deleteScheduleFileItemFile(record.id)
          .then(data => {
