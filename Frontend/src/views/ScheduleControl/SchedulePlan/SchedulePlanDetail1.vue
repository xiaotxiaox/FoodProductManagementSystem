  ...
  export default {
    ...
    methods: {
      getData () {
        ...
        api. getSchedulePlanFile1(this.id)
          .then(data => {
            console.log(data)
            this.name=data.name
            this.time=data.time
      ...
      handleChange (info) {
        if (info.file.status === 'done') {
          ...
          api. createSchedulePlanFile1(this.id, this.file)
            .then(data => {
      ...
      handleDelete (record) {
        api.deleteSchedulePlanFile1(record.id)
          .then(data => {
