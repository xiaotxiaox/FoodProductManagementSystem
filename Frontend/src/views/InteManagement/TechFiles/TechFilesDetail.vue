    ...
    methods: {
      ...
      handleChange (info) {
        if (info.file.status === 'done') {
          ...
          api.createTechnologyItemFile(this.id, this.file)
            .then(data => {
      ...
      handleDelete (record) {
        api.deleteTechnologyItemFile(record.id)
          .then(data => {
