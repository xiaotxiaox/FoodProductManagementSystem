    ...
    methods: {
      ...
      handleChange (info) {
        if (info.file.status === 'done') {
          ...
          api.createAdminiApproItemFile(this.id, this.file)
            .then(data => {
      ...
      handleDelete (record) {
        api.deleteAdminiApproItemFile(record.id)
          .then(data => {
