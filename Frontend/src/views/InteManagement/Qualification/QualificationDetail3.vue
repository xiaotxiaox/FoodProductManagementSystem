  ...
  export default {
    ...
    methods: {
      getData () {
        ...
        api. getQualiManagerFile(this.id)
          .then(data => {
            this.name=data.name
            this.style=data.style
            this.fileList = data.manager
      ...
      handleChange (info) {
        if (info.file.status === 'done') {
          ...
          api. createQualiManagerFile(this.id, this.file)
            .then(data => {
      ...
      handleDelete (record) {
        api.deleteQualiManagerFile(record.id)
          .then(data => {
