  ...
  export default {
    ...
    methods: {
      getData () {
        ...
        api. getQualiExperienceFile(this.id)
          .then(data => {
            this.name=data.name
            this.style=data.style
            this.fileList = data.experience
      ...
      handleChange (info) {
        if (info.file.status === 'done') {
          ...
          api. createQualiExperienceFile(this.id, this.file)
            .then(data => {
      ...
      handleDelete (record) {
        api.deleteQualiExperienceFile(record.id)
          .then(data => {
