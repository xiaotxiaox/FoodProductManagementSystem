  ...
  export default {
    ...
    methods: {
      getData () {
        ...
        api. getQualiLicenseFile(this.id)
          .then(data => {
            this.name=data.name
            this.style=data.style
            this.fileList = data.license
      ...
      handleChange (info) {
        if (info.file.status === 'done') {
          ...
          api. createQualiLicenseFile(this.id, this.file)
            .then(data => {
      ...
      handleDelete (record) {
        api.deleteQualiLicenseFile(record.id)
          .then(data => {
