  ...
  export default {
    ...
    methods: {
      getData () {
        ...
        api.getQualiProductFile(this.id)
          .then(data => {
            this.name=data.name
            this.style=data.style
            this.fileList = data.production_license
      ...
      handleChange (info) {
        if (info.file.status === 'done') {
          ...
          api.createQualiProductFile(this.id, this.file)
            .then(data => {
      ...
      handleDelete (record) {
        api.deleteQualiProductFile(record.id)
          .then(data => {
