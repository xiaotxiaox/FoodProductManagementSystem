  ...
  export default {
    ...
    methods: {
      getData () {
        ...
        api. getQualiCertificateFile(this.id)
          .then(data => {
            this.name=data.name
            this.style=data.style
            this.fileList = data.certificate
      ...
      handleChange (info) {
        if (info.file.status === 'done') {
          ...
          api. createQualiCertificateFile(this.id, this.file)
            .then(data => {
      ...
      handleDelete (record) {
        api.deleteQualiCertificateFile(record.id)
          .then(data => {
