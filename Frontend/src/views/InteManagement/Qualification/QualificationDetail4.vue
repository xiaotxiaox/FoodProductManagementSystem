  ...
  export default {
    ...
    methods: {
      getData () {
        ...
        api. getQualiSpecialFile(this.id)
          .then(data => {
            this.name=data.name
            this.style=data.style
            this.fileList = data.special_worker
      ...
      handleChange (info) {
        if (info.file.status === 'done') {
          ...
          api. createQualiSpecialFile(this.id, this.file)
            .then(data => {
      ...
      handleDelete (record) {
        api.deleteQualiSpecialFile(record.id)
          .then(data => {
